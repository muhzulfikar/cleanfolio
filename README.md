...
[![Imgur](https://imgur.com/FwDMNEM.gif)](https://muhzulfikar.github.io/cleanfolio)

[Live Demo](https://muhzulfikar.github.io/cleanfolio)
...
```shell
git clone https://github.com/muhzulfikar/cleanfolio
cd cleanfolio
```
...
`<title>Muh Zulfikar</title>` with `<title>Your Name</title>`.
